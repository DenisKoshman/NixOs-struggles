{ ... }:
{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "SUPER, Return, exec, [float; size 1111 700] ghostty"
      "$mod SHIFT, Return, exec, [fullscreen] ghostty"
      "$mod, B, exec, [workspace 1 silent] google-chrome"
      "$mod, Q, killactive,"
      "$mod, F, fullscreen, 0"
      ...
      "$mod, E, exec, nemo"
      "SUPER, E, exec, hyprctl dispatch exec '[float; size 1111 700] nemo'"
      ...
      "CTRL SHIFT, Escape, exec, hyprctl dispatch exec '[workspace 9] ghostty -e btop'"
      ...
      # gamemode
      "$mod, F1, exec, hyprctl --batch 'keyword animations:enabled 0; keyword decoration:shadow:enabled 0; keyword decoration:blur:enabled 0'"
      "$mod, F1, submap, game"
    ];
